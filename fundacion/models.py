...
class factura(models.Model):
    id_factura = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
...
class tratamiento(models.Model):
        id_tratamiento = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
...
class enfermedad(models.Model):
    id_enfermedad = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
    nombre = models.CharField(max_length=100)
    descripcion = models.TextField()

class medicamento(models.Model):
        id_medicamento = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
...
class viaAdministracion(models.Model):
    id_viaAdministracion = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
    nombre  = models.CharField(max_length=50, blank=False, null=False)

class horarioAtencion(models.Model):
    id_horarioAtencion = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
...
class rangoHorario(models.Model):
    id_rangoHorario = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
    nombre = models.CharField(max_length=50)

class area(models.Model):
    id_area = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
...
class especialidad(models.Model):
    id_especialidad = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
...
class laboratorio(models.Model):
    id_laboratorio = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
...
class solicitudLaboratorio(models.Model):
        id_solicitudLaboratorio = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
...
class solicitudCita(models.Model):
    id_solicitudCita = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
...
class solicitudCitaDetalle(models.Model):
    solicitudCitaDetalle = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
...
class consultaMedica(models.Model):
    id_consultaMedica = models.CharField(max_length=36, primary_key=True, default=uuid.uuid4)
